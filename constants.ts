...
export const PROJECTS: Project[] = [
  {
    ...
    date: "Oct 2025",
    description: "500+ monthly active users, zero paid acquisition — built by defining a tight product strategy around one insight: people crave real conversations with figures they admire, not generic AI. Shipped the platform solo: 350+ personas, persistent memory, voice, and a freemium paywall.",
  ...
  },
  {
    ...
    description: "Reduced credit analyst prep time from 4–6 hours to under 1 hour — by separating deterministic financial extraction (Python) from narrative synthesis (LLM), eliminating hallucinations on numbers while keeping AI focused on judgment. Shipped with bank-format Excel and PDF export to eliminate adoption friction.",
  ...
  },
  {
    ...
    date: "Jan 2026",
    image: "/job-agent.png",
    description: "Eliminated 2 hours of daily manual job searching — replaced by a 5-minute Telegram digest of 10 AI-scored roles with hiring manager details attached. Built a scraping + local LLM pipeline (Ollama/Mistral 7B) that runs on zero API cost, then rebuilt as a multi-user SaaS on Vercel.",
