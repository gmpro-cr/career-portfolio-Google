  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-10 pt-24">
        ...
        {/* Mobile avatar — circular photo, only below lg where portrait card is hidden */}
        <motion.div
        ...
        >
          <div
            ...
            style={{ boxShadow: '0 0 0 1.5px rgba(26,20,16,0.09), 0 8px 24px rgba(26,20,16,0.1)' }}
          >
            <img
              src="/profile.jpeg"
              alt="Gaurav Mahale"
        ...
        <div style={{ opacity: 0, animation: `fadeUp 0.5s ${EASE} 0.55s forwards` }}>
          ...
          >
            Finance domain expert turned AI product builder. I find the bottlenecks banks haven&rsquo;t
            automated — then build the LLM products that solve them.
          </p>
        </div>

        {/* Stats strip — Kane Sherwell pattern */}
