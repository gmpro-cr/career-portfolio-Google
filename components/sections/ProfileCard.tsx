...
const ProfileCard: React.FC = () => {
  return (
    <div className="w-full h-full p-6 grid grid-cols-1 md:grid-cols-4 grid-rows-3 gap-6">
      
      {/* 1. Identity Module (Large, 2x2) */}
      <div className="md:col-span-2 md:row-span-2 glass-panel p-8 rounded-3xl shadow-glass flex flex-col justify-between relative overflow-hidden bg-white/60">
        <div className="absolute top-0 right-0 p-6 opacity-5">
           <div className="text-9xl font-black">GM</div>
        </div>
        
        <div className="z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-[10px] font-bold tracking-wider mb-6 border border-blue-200">
            <span className="w-2 h-2 rounded-full bg-blue-600 animate-pulse"></span>
            SYSTEM OPERATIONAL
          </div>
          
          <h1 className="text-5xl md:text-7xl font-black text-canvas-text mb-4 tracking-tighter leading-[0.9]">
